...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit_4.setText(_translate("Form", "Car Number"))
        self.pushButton.setText(_translate("Form", "Save"))
        self.lineEdit_6.setText(_translate("Form", "Car Color"))
        self.lineEdit.setText(_translate("Form", "Your Name"))
        self.lineEdit_2.setText(_translate("Form", "Passward"))
        self.lineEdit_5.setText(_translate("Form", "Car model"))
        self.lineEdit_3.setText(_translate("Form", "Comf Password"))
