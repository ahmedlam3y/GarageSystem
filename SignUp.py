...
"font: 63 oblique 12pt \"URW Gothic L\";"))
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit_4.setText(_translate("Form", "Car Number", None))
        self.pushButton.setText(_translate("Form", "Save", None))
        self.lineEdit_6.setText(_translate("Form", "Car Color", None))
        self.lineEdit.setText(_translate("Form", "Your Name", None))
        self.lineEdit_2.setText(_translate("Form", "Passward", None))
        self.lineEdit_5.setText(_translate("Form", "Car model", None))
        self.lineEdit_3.setText(_translate("Form", "Comf Password", None))
